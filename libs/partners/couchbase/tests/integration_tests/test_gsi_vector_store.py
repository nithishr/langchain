"""Test Couchbase GSI Vector Store functionality"""
...
from langchain_couchbase import CouchbaseGSIVectorStore, CouchbaseSimilarityMetric
...
class TestCouchbaseVectorStore:
    ...
    def test_from_documents(self, cluster: Any) -> None:
        ...
        vectorstore = CouchbaseGSIVectorStore.from_documents(
            documents,
            ConsistentFakeEmbeddings(),
            cluster=cluster,
            ...
            similarity_metric=CouchbaseSimilarityMetric.L2,
        )
    ...
    def test_from_texts(self, cluster: Any) -> None:
        ...
        vectorstore = CouchbaseGSIVectorStore.from_texts(
            texts,
            ConsistentFakeEmbeddings(),
            cluster=cluster,
            bucket_name=BUCKET_NAME,
    ...
    def test_add_texts_with_ids_and_metadatas(self, cluster: Any) -> None:
        ...
        vectorstore = CouchbaseGSIVectorStore(
            cluster=cluster,
